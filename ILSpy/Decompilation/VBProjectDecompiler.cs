namespace ICSharpCode.ILSpy.Decompilation
{
    ...
    /// <summary>
    /// Project decompiler for the VB.NET projects.
    /// </summary>
    internal class VBProjectDecompiler : ProjectDecompiler
    {
        /// <summary>
        /// Default imports which will be added to the project file.
        /// </summary>
        ...
        public override void WriteProjectFile(System.IO.TextWriter writer, IEnumerable<Tuple<string, string>> files, Mono.Cecil.ModuleDefinition module, string defaultNamespace)
        {
            ...
            string platformName = ProjectDecompiler.GetPlatformName(module);
